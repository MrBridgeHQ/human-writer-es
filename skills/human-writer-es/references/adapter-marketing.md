...
> Doctrine for the `human-writer` skill, applied to marketing long-form: blog posts, README prose, landing pages, long-form newsletters. Loaded in addition to language-specific stylistic tells (`tells-stylistic-es.md`).
...
- `tells-stylistic-es.md`: full ES suspect vocabulary list and AI construction patterns
