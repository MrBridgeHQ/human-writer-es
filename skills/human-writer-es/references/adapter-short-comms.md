...
> Doctrine for the `human-writer` skill, applied to short-form comms: emails, LinkedIn posts and DMs, Slack/Teams messages to clients, X/Twitter replies, GitHub issue comments, customer replies. Loaded in addition to language-specific stylistic tells (`tells-stylistic-es.md`).
...
- `tells-stylistic-es.md`: full vocabulary and construction lists to avoid
- `humanization-techniques.md`: technique #6 (idiosyncratic markers) is the critical one here
- `checklists.md`: full checklists; section 12 above is the short-comms specialization
