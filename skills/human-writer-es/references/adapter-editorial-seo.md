...
Priority ranking, applied on top of the language adapter (`tells-stylistic-es.md`):
...
- `tells-stylistic-es.md`: language-specific vocabulary and construction tells
