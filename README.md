...
Spanish AI-text humanizer **with a deterministic 0–100 detector** — a Claude Code Agent Skill.
Make Spanish AI text read human, and **audit it with a score** before you publish.

**→ The skill lives in [`skills/human-writer-es/`](skills/human-writer-es/)** — `SKILL.md`, `references/`, and the `analyze.py` scorer.
